...
class Translation(): # dich tu dong tu tieng viet sang tieng anh --> Truoc khi nap vao mode CLIP
    def __init__(self, from_lang='vi', to_lang='en', mode='google'):
        ...
        if mode in 'googletrans':         # chu y model dich 
...
#class tren dung de dich nhanh hon 



class Text_Preprocessing(): # xu li va phan tich cau, phan loai, chuan hoa cau tu text
